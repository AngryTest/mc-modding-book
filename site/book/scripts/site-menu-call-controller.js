 ...
 */
{
    ...
    $(() => {
        ...
        $(window).click((e) => {
            if (!$(e.target).closest('.site-menu-button').length && !$(e.target).closest('.site-menu-items').length) {
    ...
    function init_site_menu_caller() {
        site_menu_caller = $('.site-menu-button');
        vertical_site_menu = $('.site-menu-items');
    }
